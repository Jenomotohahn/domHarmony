...
profileBox.id = 'pro2'
profileBox.innerHTML = 'A clown with a deep purpose of life of making people laugh and not cry.'
...
var name2Elem = document.getElementsByClassName('firstName');
name2Elem[1].innerHTML = 'Peko Chan';



//14. In the div id matches section, target the second div element with the class name of otherAge and change Age to 68.

var name2Age = document.getElementsByClassName('otherAge');
name2Age[1].innerHTML = '68'
